...
namespace Remotion.BuildTools.MSBuildTasks.Jira.Semver
{
    public class SemVer : IComparable<SemVer>
    {
        ...
        public int CompareTo(SemVer other)
        {
            ...
            if (PreVersion > other.PreVersion) return 1;
            if (PreVersion < other.PreVersion) return -1;
        ...
        public override int GetHashCode()
        {
          unchecked
          {
            ...
            hashCode = (hashCode*397) ^ PreVersion.GetHashCode();
            return hashCode;
          }
        }
        ...
        public override string ToString()
        {
            ...
            return string.Format("{0}.{1}.{2}-{3}.{4}", Major, Minor, Patch, Pre, PreVersion);
        }
    }
}